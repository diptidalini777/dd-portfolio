            ...
            <div className="about-intro">
                <div className="about-intro__container">
                    ...
                    <div className="about-intro__description">
                        <p data-aos='fade-right' >I am <span>Diptidalini Das</span></p>
                        ...
                        <p data-aos='fade-right' data-aos-delay='400'>Passionate front-end Developer with 1 year of experience in developing highly adaptive and responsive websites using React and PHP.</p>
