            ...
            <div className="graduation">
                <div className="graduation__container">
                    ...
                    <div className="graduation__description">
                        ...
                        <h2><FontAwesomeIcon icon={faCalendarDays} className="internships__calendar" />&nbsp;&nbsp;13/08/2021 - 31/06/2023</h2>
                        <p>Pursuing Master's of Computer Application from Silicon Institute of Technology.</p>
                    </div>
                </div>
            </div>
        </>
