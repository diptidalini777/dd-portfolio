          ...
          <div className="about__details-container">
            ...
            >
              <Link to="/about/intro">
                ...
                <p>
                  I am <span>Diptidalini Das</span> <br /> Highly passoinate
            ...
            >
              <Link to="/about/experience">
                ...
                <p>
                  ...
                  highly responsive frontend of websites using PHP and React.js .
                </p>
              </Link>
            </div>
            <div
            ...
            >
              <Link to="/about/internships">
                ...
                <ul>
                  <li>
                    <span>Syllogistek Systems Private Limited</span> - Front-end Developer{" "}
                  </li>
                </ul>
              </Link>
            </div>
            ...
            >
              <Link to="/about/graduation">
                ...
                <p>
                  <span>Silicon Institute of Technology </span>
                  <br />
